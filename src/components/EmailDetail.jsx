  ...
  return (
    ...
    >
        ...
        <div className="w-1/2 flex justify-end space-x-4 text-sm font-semibold">
          ...
          <div className="w-1/2 flex justify-end space-x-4 text-sm font-semibold">
            ...
            >
              ...
              <option value="delete" onClick={handleDeleteConfirmation}>
                Delete
              </option>
            </select>
          </div>
      ...
      {data.map((user, i) => (
        <div
          key={i}
          className="text-left space-y-2 mt-10 mx-4 p-4 border border-solid border-gray-700 rounded"
        >
          ...
          <div className="flex text-sm">
            ...
            {user.cc && user.cc.map((item, i) => <p key={i}>cc: {item}</p>)}
          </div>
