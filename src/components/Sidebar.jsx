...
export const Sidebar = ({ contentName, setContentName }) => {
  ...
  return (
    <div
      className={`w-16 min-h-screen flex flex-col border-r border-solid ${
    ...
    >
      ...
      <div className="w-16 p-2">
        <div
          className="w-8 h-8 rounded-full bg-green-700 flex justify-center items-center fixed bottom-4"
