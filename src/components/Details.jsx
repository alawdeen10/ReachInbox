...
export const Details = () => {
  ...
  return (
    ...
    >
      <div
        className={`bg-${colorMode === "light" ? "white" : "black"} p-2 mb-4`}
      >
        <h2
      ...
      >
        <h2
          className={`font-semibold text-left pl-4 py-2 ${
            colorMode === "light"
              ? "text-gray-700 bg-gray-300"
              : "text-white bg-gray-700"
          } rounded-xl w-full`}
        ...
        <div className="h-4/5 space-y-4 my-2 p-5 px-7 flex flex-col justify-around">
          ...
          {[1, 2, 3].map((step) => (
            <div key={step} className="flex items-center justify-between">
              <div
                className={`flex items-center space-x-2 space-y-2 text-${
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="flex text-left items-center space-x-1">
                    ...
                    {step === 1 && <span>Sent 3rd, Feb</span>}
                    {step !== 1 && (
                      <div
                        className={`w-0.5 h-4 bg-${
                          colorMode === "light" ? "gray-200" : "gray-600"
                        }`}
                      ></div>
                    )}
