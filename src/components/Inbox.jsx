        ...
        >
          ...
          <span
            className={`text-gray-500 text-sm ${
              colorMode === "light" ? "dark:text-gray-400" : ""
            }`}
          >
            <span
              className="font-semibold"
              style={{ color: colorMode === "light" ? "#3b4045" : "white" }}
            >
              25/25
            </span>{" "}
            Inboxes selected
            ...
            emails.map((item, i) => (
              ...
              >
                ...
                <div className="flex justify-between items-center mt-1">
                  <button
                    className={`text-xs px-2 py-1 rounded bg-green-300 text-green-700`}
                  >
                    Interested
                  </button>
                  <button
