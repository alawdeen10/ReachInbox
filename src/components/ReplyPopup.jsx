...
export const ReplyPopup = ({ threadId, token, showreplyBox }) => {
  ...
  return (
    <div className="relative">
      ...
      {showReplyBox && (
        <div
          className={`fixed bottom-20 left-1/4 ${
            colorMode === "light"
              ? "text-gray-800 border-gray-300 bg-white"
              : "text-gray-200 border-gray-600 bg-gray-800"
          } border bg-white font-semibold border rounded-lg w-1/2 h-[62%]`}
        >
          <div
            className={`text-black h-11 font-semibold rounded-t-lg ${
              colorMode === "light"
                ? "border-gray-300 bg-grey-200 text-black"
          ...
          <div
            className={`p-4 h-[78%] ${
              colorMode === "light"
                ? "border-gray-300 bg-grey-200 text-black"
                : "bg-gray-700 border-gray-900 text-grey-100"
            }`}
          >
            <input
              type="email"
              ...
              className={`border-b ${
                colorMode === "light"
                  ? "border-gray-300 bg-grey-200 text-black"
                  : "bg-gray-700 border-gray-900 text-grey-100 "
              } focus:outline-none w-full py-2 px-4 bg-transparent`}
            ...
            <input
              ...
              value={data.subject}
              onChange={handleChange}
              className={`focus:outline-none w-full py-2 px-4 bg-transparent ${
                colorMode === "light" ? "text-black" : "text-grey-100 "
              }`}
            ...
            <textarea
              ...
              value={data.body}
              onChange={handleChange}
              className={`resize-none h-4/6 border ${
                colorMode === "light"
                  ? "border-gray-300 bg-grey-200 text-black"
                  : "bg-gray-700 border-gray-900 text-grey-100 "
              } focus:outline-none w-full py-2 px-4 bg-transparent`}
          ...
          <div
            className={`flex gap-5 items-center border-t border-gray-300 dark:border-gray-600 p-2 ${
              colorMode === "light"
                ? "border-gray-300 bg-grey-200 "
